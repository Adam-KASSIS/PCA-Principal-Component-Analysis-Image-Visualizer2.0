...
const PCAVisualization1D = ({ pcaData, onPointClick, showTextLabels }) => {
    ...
    <div className="plotly-container">
      <Plot
        data={[{
          ...
          y: new Array(coordinates.length).fill(0),
          ...
          hovertemplate: '<b>Image %{text}</b><br>PC1: %{x:.4f}<br><i>Click to view details</i><extra></extra>'
        }]}
        layout={{
...
export default PCAVisualization1D;
